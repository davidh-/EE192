...
volatile float refVel = 2.0; // Corresponds to m/s
const float refVel_strt = 2.0; // Corresponds to m/s
const float refVel_turn = 1.8; // Corresponds to m/s
...
volatile float Kp_steer = 4.8; //in degrees of steering per pixel error
const float Kp_turn = 5.1;
const float Kp_strt = 4.8;

volatile float Kd_steer = 0.9; //in degrees/s of steering change per pixel error
const float Kd_turn = 0.9;
const float Kd_strt = 0.9;

volatile int err_steer = 0;
volatile int last_err_steer = 0;
volatile int derivTerm = 0;
volatile float input_steer = 0.0;
const int steering_bound = 90;
